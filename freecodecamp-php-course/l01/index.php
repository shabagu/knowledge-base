...
<main>
    <section class="list">
        <h3>Список уроков</h3>
        <ol>
            <li class="selected"><a href="../l01/index.php">Introduction</a></li>
    ...
    <section class="description">
        <h3>Вступление</h3>
        <p>О PHP в <a href="https://ru.wikipedia.org/wiki/PHP" target="_blank">википедии</a></p>
        <p><a href="https://gb.ru/posts/roadmap-php-developer" target="_blank">Дорожная карта</a> PHP (перевод статьи с сайта dev.to)</p>
        <p><a href="https://gb.ru/posts/roadmap-php-developer" target="_blank">Дорожная карта</a> PHP от Zura (The Codeholic)</p>
    </section>
</main>
</body>
</html>
