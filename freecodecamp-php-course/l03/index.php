...
<main>
    <section class="list">
        ...
        <ol>
            ...
            <li class="selected"><a href="../l03/index.php">Choosing a Text Editor</a></li>
    ...
    <section class="description">
        <h3>Выбор IDE</h3>
        <div>Оптимальная среда разработки - <a href="https://www.jetbrains.com/ru-ru/phpstorm/">PhpStorm</a></div>
        <p>Существующие аналоги:</p>
        <ul>
