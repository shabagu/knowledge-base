...
<main>
    <section class="list">
        ...
        <ol>
            ...
            <li class="selected"><a href="../l04/index.php">Hello World & Setup</a></li>
    ...
    <section class="description">
        ...
        <ul>
            <li>cmd</li>
            <li><span class="console">> cd /d E:\learning\php\freecodecamp</span> - смена рабочей директории командной строки</li>
            <div style="margin-left: 12px">* флаг /d необходим при смене физического диска</div>
            <li><span class="console">> php -S localhost:4000</span> - запуск PHP-сервера на заданном порту</li>
            <li>в адресной строке бразуера → http://localhost:4000</li>
            <div style="margin-left: 12px">* отобразится содержимое файла E:\learning\php\freecodecamp\index.php</div>
            <li>Ctrl + C (^C) - остановка процесса</li>
        </ul>
        <h3>Hello, world!</h3>
<pre class="php">
<span class="orange">&lt;?php</span>
    <span class="other">...php-код...</span>
<span class="orange">?&gt;</span>
<hr>
<span class="orange">&lt;?php echo</span> <span class="green">"Hello, world!"</span><span class="orange">; &gt;</span>
<hr>
<span class="orange">&lt;?php echo </span><span class="other"> ≡ </span> <span class="orange">&lt;?=</span>
<hr></pre>
    </section>
</main>
</body>
